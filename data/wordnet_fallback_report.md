...
- Current public rights-cleared layer: **324** terms with exactly one displayed corpus definition newly reach two source-separated definitions; **1032** picker terms have at least two after opt-in.
- Static JSON payload: **881,976 bytes**, containing **6158** WordNet synsets.
