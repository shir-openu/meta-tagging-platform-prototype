...
- Current all-corpus layer: **698** terms with exactly one corpus definition newly reach two source-separated definitions; **2835** picker terms have at least two after opt-in.
- Current public rights-cleared layer: **514** terms with exactly one displayed corpus definition newly reach two source-separated definitions; **1790** picker terms have at least two after opt-in.
- Static JSON payload: **878,655 bytes**, containing **6158** WordNet synsets.
