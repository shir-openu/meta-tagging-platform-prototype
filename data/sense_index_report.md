...
Generated 2026-09-15T16:50:34+00:00 from `DATA/corpus.json` SHA-256 `cc02de41a696a7087823b02082a5826187e6f36a75b52fb5d3534a5499f8b249`.

| Finding | Count |
|---|---:|
| Active grounded rows across all three layers | 25,694 |
| Active legacy `senses` rows | 6,481 |
| Active `content_tags.definitions` rows | 5,409 |
...
| Picker terms with publishable grounded senses | 666 |
| Publishable multi-paper picker terms | 676 |
| Publishable one-paper picker terms | 10,437 |
| Withdrawn rows excluded | 519 |
...
| Parsed rows bound by exact case-folded picker label | 20,934 |
| Parsed rows bound after removing one presentation wrapper | 207 |
| Parsed rows without a safe picker-term match | 2,602 |
| Papers with more than one active sense | 1,086 |
| Paper/head groups with multiple active senses | 2,730 |
