...
Generated 2026-09-08T10:56:02+00:00 from `DATA/corpus.json` SHA-256 `b7738a34d29afc90fc8b797f15e948a7393167828d70c29423938281eda05aeb`.

| Finding | Count |
|---|---:|
| Active grounded rows across all three layers | 25,448 |
| Active legacy `senses` rows | 6,442 |
| Active `content_tags.definitions` rows | 5,456 |
| Active `concepts` rows | 13,550 |
| Verbatim sense rows published after audited rights gate | 3,072 |
| Verbatim sense rows withheld by rights gate | 3,370 |
| Picker terms with publishable grounded senses | 623 |
| Publishable multi-paper picker terms | 531 |
| Publishable one-paper picker terms | 9,927 |
...
| Parsed rows bound by exact case-folded picker label | 20,695 |
| Parsed rows bound after removing one presentation wrapper | 203 |
| Parsed rows without a safe picker-term match | 2,599 |
| Papers with more than one active sense | 1,078 |
| Paper/head groups with multiple active senses | 2,511 |
...
- `ancestry` — 2 row(s)
- `bottom-up` — 2 row(s)
- `cofinite soft topology` — 2 row(s)
- `colour` — 2 row(s)
...
- `separability` — 2 row(s)
- `soft base` — 2 row(s)
- `soft open base` — 2 row(s)
- `soft set` — 2 row(s)
- `soft topology` — 2 row(s)
