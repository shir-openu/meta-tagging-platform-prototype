...
const I18N = {
  he: {
    ...
    "concept.counts": "{p} מאמרים משתמשים במונח · {s} נוקדו · {c} מקרים מוכרעים · {d} הגדרות",
    ...
    "concept.tally.rivals": "ל־{d} מונחים יש שתי הגדרות מתחרות או יותר, מרוכזות ברשימה אחת, עם הקטע המדויק שמאחורי כל אחת.",
    "start.here": "את אלה הספרות מגדירה יותר מפעם אחת. פתחו אחד כדי לקרוא את כל ההגדרות המתחרות ברשימה, כל אחת מקושרת לקטע שממנו נגזרה.",
    "evidence.compare": "הניסוחים, זה מתחת לזה — {n} מהם. כל אחד מקשר למאמר ולקטע שממנו נגזר.",
    "start.chip": "{n} ב־{f} תחומים",
    "concept.corpusonly": "{n} מאמרים · לחצו לצפייה בקורפוס · לא ניתן לנקד עדיין",
    "concept.disputed": "{n} מאמרים · {d} מהם מתווכחים על משמעותו · אפשר לבנות לוח",
    "concept.evidenceonly": "{n} מאמרים · {s} מובנים מעוגנים · ראיות בלבד, ללא ניקוד אמת־מידה",
    "concept.coverage": "{n} מאמרים · {s} מובנים מעוגנים · בדיקת כיסוי שימושים זמינה",
    "cap.benchmark.h": "ניקוד אמת־מידה",
    "cap.benchmark.body": "יש למונח הזה מקרי חיוב ושלילה שנשפטו בנפרד; מטריצת בלבול ו־MCC זמינים.",
    "cap.coverage.h": "כיסוי שימושים מתועדים",
    "cap.coverage.body": "יש שימושים מעוגנים ביותר ממאמר אחד. אפשר לבדוק ידנית אילו שימושים ההגדרה מכסה, אך אין מקרי שלילה עצמאיים ולכן זה אינו ניקוד אמת־מידה.",
    "cap.evidence.h": "ראיות בלבד",
    "cap.evidence.body": "יש מובנים מעוגנים וציטוטים מדויקים, אך אין מקרי חיוב ושלילה בלתי־תלויים; לכן אין MCC או bootstrap.",
    "cap.buyboard": "להזמין לוח למונח הזה",
    "cap.buyboard.note": "שירות ידני. אין חיוב לפני שהמונח מתקבל.",
    "cap.nodefs": "לא נכתבו הגדרות למושג הזה, ולכן אין עדיין מה לנקד. מוכנים לניקוד:",
    "cap.corpus.h": "קורפוס בלבד",
    "cap.corpus.body": "אפשר לבחור ולעיין במאמרים, אך אין עדיין מובן שנקשר בבטחה למונח ואין אמת־מידה לניקוד.",
    "cap.screens": "יכולות המונח",
    "cap.screen.evidence": "ראיות בלבד",
    "cap.screen.coverage": "כיסוי שימושים מתועדים",
    "cap.screen.benchmark": "ניקוד אמת־מידה",
    "cap.ready": "זמין",
    "cap.unavailable": "לא זמין",
    "cap.coverage.hold": "בהמתנה; כיסוי חיובי בלבד אינו ציון",
    "evidence.step": "פתחו את הראיות וכתבו הגדרה משלכם",
    "evidence.stage": "ראיות ל־{term} — מתוך {n} המאמרים שבחרתם",
    "evidence.stage.all": "כל ההגדרות של {term} בקורפוס",
    "evidence.summary": "{s} מובנים מעוגנים מתוך {p} מאמרים בקורפוס שבחרתם. כל ניסוח פרשני מוצג לצד המשפט המדויק שמבסס אותו.",
    "evidence.summary.all": "{s} הגדרות מתחרות מתוך {p} מאמרים ב־{f} תחומים. כל ניסוח פרשני מוצג לצד הקטע המדויק שמצדיק אותו.",
    "evidence.oldest": "הגדרת המאמר הוותיק ביותר בקורפוס שבחרתם",
    "evidence.oldest.all": "ההגדרה של המאמר הוותיק ביותר בקורפוס הזה",
    "evidence.newest": "הגדרת המאמר החדש ביותר בקורפוס שבחרתם",
    "evidence.newest.all": "ההגדרה של המאמר החדש ביותר בקורפוס הזה",
    "evidence.cited": "הגדרת המאמר המצוטט ביותר בקורפוס שלכם",
    "evidence.cited.all": "ההגדרה של המאמר המצוטט ביותר בקורפוס הזה",
    "evidence.onepaper": "רק מאמר אחד בקורפוס שבחרתם מגדיר את המונח; לכן הוא מוצג פעם אחת עם כל המובנים הרלוונטיים שלו.",
    "evidence.onepaper.all": "רק מאמר אחד בקורפוס הזה מגדיר את המונח, ולכן הוא מוצג פעם אחת עם כל המובנים הרלוונטיים שלו.",
    "evidence.year.unavailable": "לא ניתן לבחור ותיק/חדש ביושר: חסרה שנה ל־{n} מן המאמרים המועמדים.",
    "evidence.oldest.tie": "יש תיקו על המאמר הוותיק ביותר: {n} מאמרים משנת {y}; כולם מסומנים.",
    "evidence.newest.tie": "יש תיקו על המאמר החדש ביותר: {n} מאמרים משנת {y}; כולם מסומנים.",
    "evidence.cited.unavailable": "האפשרות 'המצוטט ביותר' אינה זמינה: חסר מספר ציטוטים ל־{n} מתוך {all} מאמרים. לא נבחר מנצח שגוי.",
    "evidence.none.selected": "למונח יש {n} מובנים מעוגנים באינדקס, אך אף אחד מהם אינו מן המאמרים שבחרתם.",
    "evidence.all.corpus": "כל המובנים של המונח, מכל מאמרי הקורפוס שלו. בחרו קורפוס כדי לצמצם.",
    "evidence.none.term": "לא נמצא מובן שניתן לקשור בבטחה למונח הזה. אפשר עדיין לכתוב ולשמור הגדרה משלכם, אך אין מקור שנוכל לייחס לו הגדרת ברירת מחדל.",
    "evidence.gloss.note": "גלוסה פרשנית של הפרויקט — לא ציטוט ולא ניסוח שמיוחס למחברי המאמר.",
    "evidence.quote": "הקטע המדויק שמבסס את המובן",
    "evidence.source": "פתיחת המקור",
    "evidence.ourpage": "העמוד המתויג",
    "evidence.chars": "תווים",
    "evidence.citation": "ציטוטים שמורים",
    "evidence.add": "הוספת הגדרה משלכם",
    "evidence.all": "כל המובנים המעוגנים בקורפוס שבחרתם",
    "evidence.all.all": "כל המובנים המעוגנים של המונח",
    "evidence.audit": "האינדקס כולל {active} מובנים פעילים; {hard} לא ניתנים לפיצול תחבירי ו־{ambig} עמומים במפריד.",
    "evidence.audit.link": "דוח הכשלים המלא",
    "external.no.corpus": "לא נמצאה הגדרה בקורפוס הזה.",
    "external.corpus.withheld": "הגדרות קורפוס קיימות אך אינן ניתנות להצגה בשל מגבלות זכויות הפרסום.",
    "external.heading": "הגדרות חיצוניות חלופיות — אינן נגזרות מן הקורפוס הזה",
    "external.optin": "הצגת WordNet 3.0 כמקור חיצוני להגדרות מתחרות",
    "external.off": "כבוי כברירת מחדל. הפעילו רק אם ברצונכם להשוות למילון חיצוני.",
    "external.source": "מקור",
    "external.licence": "רישיון",
    "external.notice": "ייחוס והודעת רישיון",
    "external.rival": "הגדרה חיצונית מתחרה",
    "external.separation": "שכבה זו אינה משנה מובני קורפוס, ספירות, יכולות או ציונים.",
    "external.senses": "{n} מובנים מילוניים זמינים; כולם מוצגים, ולא נבחר מובן ראשון באופן סמוי.",
    "coverage.screen": "מסך כיסוי שימושים — לא מסך ניקוד",
    "coverage.h": "אילו שימושים מתועדים הניסוח הזה משאיר בחוץ?",
    "coverage.choose": "בחרו 'בדיקת הניסוח הזה' ליד מובן מעוגן, או הוסיפו הגדרה משלכם.",
    "coverage.warning": "זהו מבחן חיובי בלבד. הוא אינו בודק הכללות שגויות, ולכן אין כאן TN, FP, MCC, מטריצת בלבול או bootstrap.",
    "coverage.need.two": "בחרו לפחות שני מאמרים שיש בהם מובנים מעוגנים כדי לפתוח בדיקת כיסוי.",
    "coverage.no.heldout": "לא נותר שימוש ממאמר אחר לאחר הוצאת מאמר המקור של ההגדרה. אין כאן סט בדיקה מוחזק.",
    "coverage.source.excluded": "מאמר המקור הוצא מן הבדיקה כדי למנוע יתרון ביתי: {paper}",
    "coverage.source.user": "זו הגדרת משתמש, ולכן כל השימושים המתועדים בקורפוס הנבחר נשארים בבדיקה.",
    "coverage.caseweighted": "כיסוי לפי מובנים שהוכרעו",
    "coverage.paperweighted": "ממוצע כיסוי לפי מאמר",
    "coverage.covered": "מובנים מכוסים",
    "coverage.uncertain": "לא ודאיים",
    "coverage.reset": "איפוס ההכרעות בבדיקה הזאת",
    "coverage.v.covered": "מכוסה בהגדרה",
    "coverage.v.omitted": "נשאר מחוץ להגדרה",
    "coverage.v.uncertain": "לא ניתן להכריע",
    "coverage.test.this": "בדיקת הניסוח הזה",
    "coverage.own.label": "ההגדרה שלכם",
    "coverage.own.test": "בדיקה מול שימושים מתועדים",
    "coverage.own.save": "שמירה ותיארוך",
    "coverage.unavailable.one": "אפשר לשמור את ההגדרה, אך למונח הזה אין יותר ממאמר אחד עם מובן שניתן לפרסום ולכן אין בדיקת כיסוי.",
    ...
    "concept.note": "שלושת המושגים אינם בני־השוואה זה לזה במספרים — רק בשיטה. כל הרצה נוקדה בנפרד, וניסוח ההנחיה לבדו מזיז MCC בכ־0.12. מה שכן משותף: אותו כלל, אותה מטריקה, ואותה דרישה שהבקרה תכייל את הטבלה — אבל <b>הבקרה אינה אותה בקרה</b>. באומנות \"מה שקוראים לו אומנות\" היא טאוטולוגיה שמכיילת; במשחק אותו משפט הוא עמדה שנויה במחלוקת שמפסידה לחמש הגדרות מהספרות. בתודעה זו ברירת המחדל של התחום, שהגדרה אחת על הלוח יוצאת לערער עליה. התודעה גם נושאת את הטבלה הקטנה ביותר כאן — 12 מקרים מוכרעים — ושבע מתשע ההגדרות שלה שוות בדיוק, משום שהמקרים שמפרידים ביניהן הם אלה שהספרות אינה מכריעה.",
    ...
    "board.noboard": "למושג {term} אין לוח הגדרות. בחלון המושג כתוב כמה מאמרים יש לנו עליו ומה דרוש כדי לבנות לוח.",
    ...
    "prov.usage": "שימוש רגיל, לא מן הספרות",
    "prov.control": "בקרה מכוונת",
    "prov.unknown": "מקור לא ידוע",
    "offer.misses": "מקרים שגויים",
    "offer.shown": "מוצגות {k} מתוך {n}.",
    "offer.tie": "{t} מהן שוות בציון {s} — תיקו הוא ממצא על הקורפוס, לא דירוג: על המקרים האלה הקורפוס אינו מבחין ביניהן.",
    "offer.showall": "הצגו את כל {n}",
    "offer.showfewer": "הצגו את {k} המובילות",
    ...
    "judge.definition.required": "יש לכתוב את ההגדרה המדויקת לפני תחילת ההכרעה. הטקסט הוא חלק מזהות ההרצה.",
    "judge.bound": "הכרעות אלה קשורות להגדרה, לקורפוס, לגרסת סט המקרים ולמונח הזה בלבד · מזהה {id}",
    "judge.cases": "מקרים — לחצו על תא כדי לבדוק אותם",
    "judge.mcc.unavailable": "חישוב MCC עדיין אינו מוגדר: המכנה דורש שונות גם בתוויות הייחוס וגם בהכרעות כן/לא שלכם.",
    "judge.mcc.provisional": "זו תוצאת ביניים; הציון הסופי דורש הכרעה בכל מקרה.",
    "feature.h": "על איזה מאפיין ההגדרה שלכם נשענת?",
    "feature.body": "הדפדפן אינו מנחש מתוך טקסט חופשי. אשרו את המאפיין שנוסח ההגדרה שלכם דורש; הייחוס שיישמר הוא הייחוס שלכם.",
    "feature.layer.subterm": "תת־מונח / מחויבות סוג שנבדקה",
    "feature.layer.criterion": "קריטריון מוצע להגדרה",
    "feature.criteria": "{n} קריטריונים שנאספו לאמנות",
    "feature.answer": "המיפוי שאישרתם: {features}",
    "feature.none": "טרם אושר מיפוי.",
    "feature.unavailable.term": "למונח זה אין שכבת קריטריונים שנבדקה. הכלי לא ימציא תשובה מתוך הטקסט.",
    "feature.unavailable.concept": "למושג זה אין שכבת קריטריונים או תת־מונחים שנבדקה. הכלי לא ימציא תשובה.",
    "feature.v.object": "אובייקט",
    "feature.v.notobject": "לא אובייקט",
    "feature.v.undecided": "לא הוכרע",
    "feature.object.overlap": "{n} מתוך {all} מקרי אובייקט חופפים לקורפוס שבחרתם.",
    "feature.object.source": "בבדיקת המקור: {p} אובייקט, {n} לא אובייקט, {u} לא הוכרע.",
    "feature.object.limit": "אלה מקרי שכבת האובייקט, לא המקרים שהקריטריון הכריע בהם שולית בתוך ההגדרה המלאה. לכך דרושות עמודות הכרעה לכל קריטריון, שעדיין אינן קיימות.",
    "feature.cases": "בדיקת {n} המקרים והראיות",
    "feature.no.columns": "אין עדיין עמודות הכרעה קריטריון×מקרה; לכן אין ייחוס אוטומטי ואין טענה אילו מקרים קריטריון יחיד הכריע.",
    "feature.saved": "מיפוי שאושר בידי המשתמש",
    "own.text.lab": "ההגדרה",
    ...
    "btn.board.why": "שלוש־עשרה הגדרות של אומנות. אלה שאינן בקרות ואינן נפסלות מדורגות לפי מידת ההתאמה לקורפוס שבחרתם; מתחת לכל אחת אפשר לפתוח את רשימת המקרים שהיא טועה בהם, ולכל מקרה מוצג המשפט המדויק מהמאמר.",
    ...
    "jack.topk": "{k} המאמרים שהסרתם מזיזה הכי הרבה את הציון של המובילה",
    "jack.top1": "המאמר שהסרתו מזיזה הכי הרבה את הציון של המובילה",
  ...
  en: {
    ...
    "concept.counts": "{p} papers use the term · {s} scored · {c} adjudicated cases · {d} definitions",
    ...
    "concept.tally.rivals": "{d} terms carry two or more rival definitions, listed together, with the exact passage behind each.",
    "start.here": "The literature defines these more than once. Open one to read every rival definition in a list, each linked to the passage it came from.",
    "evidence.compare": "The wordings, one under another — {n} of them. Each links to its paper and the passage it came from.",
    "start.chip": "{n} in {f} fields",
    "concept.corpusonly": "{n} papers · click to see the corpus · not scoreable yet",
    "concept.disputed": "{n} papers · {d} of them argue what it means · a board could be built",
    "concept.evidenceonly": "{n} papers · {s} grounded senses · evidence only, no benchmark score",
    "concept.coverage": "{n} papers · {s} grounded senses · attested-use coverage available",
    "cap.benchmark.h": "benchmark score",
    "cap.benchmark.body": "This term has independently judged positive and negative cases; confusion matrix and MCC are available.",
    "cap.coverage.h": "attested-use coverage",
    "cap.coverage.body": "Grounded uses exist in more than one paper. You can judge which uses a definition covers, but there are no independent negatives, so this is not a benchmark score.",
    "cap.evidence.h": "evidence only",
    "cap.evidence.body": "Grounded senses and exact passages are available, but independent positive and negative cases are not; MCC and bootstrap are unavailable.",
    "cap.buyboard": "Have this term's board built",
    "cap.buyboard.note": "Manual service. Nothing is charged before the term is accepted.",
    "cap.nodefs": "No definitions have been written for this concept, so there is nothing to score yet. Ready to score:",
    "cap.corpus.h": "corpus only",
    "cap.corpus.body": "Papers can be selected and browsed, but no grounded sense is safely bound to this term and no scoring benchmark exists yet.",
    "cap.screens": "term capabilities",
    "cap.screen.evidence": "evidence only",
    "cap.screen.coverage": "attested-use coverage",
    "cap.screen.benchmark": "benchmark score",
    "cap.ready": "available",
    "cap.unavailable": "unavailable",
    "cap.coverage.hold": "on hold; positive-only coverage is not a score",
    "evidence.step": "open the evidence and write your own definition",
    "evidence.stage": "Evidence for {term} — from the {n} papers you chose",
    "evidence.stage.all": "Every definition of {term} in the corpus",
    "evidence.summary": "{s} grounded senses from {p} papers in your chosen corpus. Every interpretive wording is shown beside the exact passage that licenses it.",
    "evidence.summary.all": "{s} rival definitions from {p} papers across {f} fields. Every interpretive wording is shown beside the exact passage that licenses it.",
    "evidence.oldest": "Definition of the oldest paper in your chosen corpus",
    "evidence.oldest.all": "Definition of the oldest paper in this corpus",
    "evidence.newest": "Definition by the newest paper in your chosen corpus",
    "evidence.newest.all": "Definition by the newest paper in this corpus",
    "evidence.cited": "Definition by the most cited paper in your corpus",
    "evidence.cited.all": "Definition by the most cited paper in this corpus",
    "evidence.onepaper": "Only one paper in your chosen corpus defines this term, so it is shown once with all of its relevant senses.",
    "evidence.onepaper.all": "Only one paper in this corpus defines this term, so it is shown once with all of its relevant senses.",
    "evidence.year.unavailable": "Oldest/newest cannot be selected honestly: {n} candidate paper(s) have no stored year.",
    "evidence.oldest.tie": "Oldest is tied across {n} papers from {y}; all are marked rather than silently breaking the tie.",
    "evidence.newest.tie": "Newest is tied across {n} papers from {y}; all are marked rather than silently breaking the tie.",
    "evidence.cited.unavailable": "Most cited is unavailable: {n} of {all} candidate papers lack a citation count. No false winner was selected.",
    "evidence.none.selected": "This term has {n} grounded senses in the index, but none comes from the papers you selected.",
    "evidence.all.corpus": "Every definition of this term, from all the papers in its corpus. Choose a corpus to narrow it.",
    "evidence.none.term": "No grounded sense can yet be bound safely to this term. You can still write and save your own definition, but there is no source we can attribute a default definition to.",
    "evidence.gloss.note": "Project curatorial gloss — not a quotation or wording attributed to the paper's authors.",
    "evidence.quote": "Exact attesting passage",
    "evidence.source": "open source",
    "evidence.ourpage": "the tagged page",
    "evidence.chars": "characters",
    "evidence.citation": "stored citations",
    "evidence.add": "add your own definition",
    "evidence.all": "All grounded senses in your chosen corpus",
    "evidence.all.all": "All grounded senses of this term",
    "evidence.audit": "The index contains {active} active senses; {hard} cannot be split syntactically and {ambig} have ambiguous delimiters.",
    "evidence.audit.link": "full failure report",
    "external.no.corpus": "No definition found in this corpus.",
    "external.corpus.withheld": "Corpus definitions exist but are not displayable because of publication-rights restrictions.",
    "external.heading": "External fallback definitions — not derived from this corpus",
    "external.optin": "Show WordNet 3.0 as an external source of rival definitions",
    "external.off": "Off by default. Enable only if you want to compare against an external dictionary.",
    "external.source": "Source",
    "external.licence": "License",
    "external.notice": "attribution and license notice",
    "external.rival": "external rival definition",
    "external.separation": "This layer never changes corpus senses, counts, capabilities, or scores.",
    "external.senses": "{n} dictionary senses available; all are shown and no first sense is selected silently.",
    "coverage.screen": "attested-use coverage screen — not a score screen",
    "coverage.h": "Which documented uses would this wording leave out?",
    "coverage.choose": "Choose “test this wording” on a grounded sense, or add your own definition.",
    "coverage.warning": "This is a positive-use stress test only. It cannot detect false inclusions, so there is no TN, FP, MCC, confusion matrix or bootstrap here.",
    "coverage.need.two": "Select at least two papers with grounded senses to open the coverage test.",
    "coverage.no.heldout": "No use from another paper remains after excluding the definition's source paper. There is no held-out test set.",
    "coverage.source.excluded": "The definition's source paper is excluded to avoid home-field advantage: {paper}",
    "coverage.source.user": "This is a user definition, so every documented use in the chosen corpus remains in the test.",
    "coverage.caseweighted": "coverage over decided senses",
    "coverage.paperweighted": "mean coverage by paper",
    "coverage.covered": "senses covered",
    "coverage.uncertain": "uncertain",
    "coverage.reset": "clear this test's judgements",
    "coverage.v.covered": "covered by the definition",
    "coverage.v.omitted": "left out by the definition",
    "coverage.v.uncertain": "cannot tell",
    "coverage.test.this": "test this wording",
    "coverage.own.label": "Your definition",
    "coverage.own.test": "test against documented uses",
    "coverage.own.save": "save and timestamp it",
    "coverage.unavailable.one": "You can save the definition, but this term has no more than one paper with a publishable grounded sense, so no coverage test is available.",
    ...
    "concept.note": "The three concepts are not comparable to each other in their numbers — only in their method. Each was scored in its own run, and instruction wording alone moves MCC by about 0.12. What they share: one rule, one metric, and the requirement that a control calibrate the table — but <b>it is not the same control</b>. For art, \"whatever people call art\" is a tautology that calibrates everything else; for game the same sentence is a contested position that loses to five published definitions; for consciousness it is the field’s default, which one definition on the board sets out to overrule. Consciousness also carries the smallest table here — 12 adjudicated cases — and seven of its nine definitions tie, because the cases that divide them are the ones the literature cannot decide.",
    ...
    "board.noboard": "{term} has no definition board. The concept panel says how many papers we hold on it, and what building one would take.",
    ...
    "prov.usage": "ordinary usage, not from the literature",
    "prov.control": "deliberate control",
    "prov.unknown": "provenance unknown",
    "offer.misses": "cases wrong",
    "offer.shown": "Showing {k} of {n}.",
    "offer.tie": "{t} of them tie at {s} — a tie is a finding about the corpus, not a ranking: on these cases the corpus cannot tell them apart.",
    "offer.showall": "show all {n}",
    "offer.showfewer": "show the top {k}",
    ...
    "judge.definition.required": "Write the exact definition before judging. Its text is part of this run's identity.",
    "judge.bound": "These judgements are bound to this definition, corpus, case-set version and concept only · id {id}",
    "judge.cases": "cases — inspect the evidence behind this cell",
    "judge.mcc.unavailable": "MCC is not defined yet: its denominator needs variation in both the reference labels and your yes/no judgements.",
    "judge.mcc.provisional": "This is an interim result; the final score requires a verdict on every case.",
    "feature.h": "What does your definition turn on?",
    "feature.body": "The browser does not guess from free text. Confirm the reviewed feature your wording requires; the saved attribution is yours.",
    "feature.layer.subterm": "reviewed sub-term / type commitment",
    "feature.layer.criterion": "candidate definitional criterion",
    "feature.criteria": "{n} art criteria",
    "feature.answer": "Your confirmed mapping: {features}",
    "feature.none": "No mapping confirmed yet.",
    "feature.unavailable.term": "This term has no reviewed criteria layer. The tool will not invent an answer from the wording.",
    "feature.unavailable.concept": "This concept has no reviewed criteria or sub-term layer. The tool will not invent an answer.",
    "feature.v.object": "object",
    "feature.v.notobject": "not object",
    "feature.v.undecided": "undecided",
    "feature.object.overlap": "{n} of {all} reviewed object-layer cases overlap your selected corpus.",
    "feature.object.source": "Source review: {p} object, {n} not object, {u} undecided.",
    "feature.object.limit": "These are object-layer cases, not cases this criterion marginally decides inside the full definition. That claim needs criterion-by-case verdict columns, which do not yet exist.",
    "feature.cases": "inspect {n} cases and their evidence",
    "feature.no.columns": "There are no criterion × case verdict columns yet, so there is no automatic attribution and no claim about which cases one criterion decided.",
    "feature.saved": "user-confirmed mapping",
    ...
    "btn.board.why": "Thirteen definitions of art. The ones that are neither controls nor disqualified are ranked by how well they fit the corpus you chose; under each you can open the list of cases it gets wrong, and every case shows the exact sentence from the paper.",
    ...
    "jack.topk": "The {k} papers whose removal moves the leader's score the most",
    "jack.top1": "The paper whose removal moves the leader's score the most",
