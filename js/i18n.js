...
const I18N = {
  he: {
    ...
    "concept.tally.rivals": "ל־{d} מונחים יש שתי הגדרות מתחרות או יותר, שאפשר לקרוא זו לצד זו עם הקטע המדויק שמאחורי כל אחת.",
    "start.here": "את אלה הספרות מגדירה יותר מפעם אחת. פתחו אחד כדי לקרוא את ההגדרות המתחרות זו לצד זו, כל אחת לצד הקטע שממנו נגזרה.",
  ...
  en: {
    ...
    "concept.tally.rivals": "{d} terms carry two or more rival definitions you can read side by side, with the exact passage behind each.",
    "start.here": "The literature defines these more than once. Open one to read the rival definitions side by side, each beside the passage it came from.",
