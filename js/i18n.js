...
const I18N = {
  he: {
    ...
    "evidence.summary.all": "{s} הגדרות מתחרות מתוך {p} מאמרים. כל ניסוח פרשני מוצג לצד הקטע המדויק שמצדיק אותו.",
  ...
  en: {
    ...
    "evidence.summary.all": "{s} rival definitions from {p} papers. Every interpretive wording is shown beside the exact passage that licenses it.",
